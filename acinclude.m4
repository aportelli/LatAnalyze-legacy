...
[
    ...
    AS_IF([test -z "$3"],[ax_gcc_option_test="int main(){return 0;}"],
    ...
    AS_IF([AC_TRY_COMMAND($CC $2 $1 -c conftest.c 1>&AS_MESSAGE_LOG_FD)],
          [AC_MSG_RESULT([yes])$4],[AC_MSG_RESULT([no])$5])],
...
[
    GCC_VERSION=""
    AX_GCC_OPTION([-dumpversion],[],[],[ax_gcc_version_option=yes],
...
[
    ...
    for ventest in intel:__ICC,__ECC,__INTEL_COMPILER 
                   ...
                   hp:__HP_cc,__HP_aCC dec:__DECC,__DECCXX,__DECC_VER,
                      __DECCXX_VER 
    ...
    do
        ...
        AC_COMPILE_IFELSE([AC_LANG_PROGRAM(,[#if !($vencpp)
                                                 thisisanerror;
                                             #endif])],
